...
if (isset($_GET['lang']) && in_array($_GET['lang'], ['id', 'en', 'cn'])) {
    ...
    // Bersihkan URL dari parameter ?lang=... agar tidak menumpuk
...
$page_paths = [
    'dashboard' => 'src/pages/teacher-dashboard-content.php',
    'schedule' => 'src/pages/teacher-schedule.php',
    'exams' => 'src/pages/teacher-exams.php',
    'profile' => 'src/pages/teacher-profile.php',
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Teacher Dashboard - Bimbel Let's Shine</title>
...
<body class="bg-gray-50 font-['Poppins']">
    <div class="flex h-screen">
        <div class="hidden lg:block w-64 flex-shrink-0">
            <?php include 'src/components/teacher-sidebar.php'; ?>
        </div>
    ...
    <div class="lg:hidden">
        <?php include 'src/components/teacher-mobile-nav.php'; ?>
    </div>
